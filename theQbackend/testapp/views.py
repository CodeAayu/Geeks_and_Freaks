...
def savetheevent(request):
    ...
    genre = data["genre"]
    ans = EventData.objects.create(event_name=event_name, date_start=event_date_start, date_end=event_date_end, description=event_description, city=event_city, event_cover_image=image, genre=genre)
