...
export default class Singing extends Component {
    constructor(props) {
      super(props);
           ...
           <FlatList
             ...
             renderItem={( {item} ) => (
               <View>
                 ...
                 {item.genre == 'Singing' ?<TouchableHighlight onPress = {()=>navigate('details',{id : item.event_id , name: item.event_name ,genre:item.genre,des:item.description ,start:item.date_start , end:item.date_end ,img:item.event_cover_image ,city:item.city})}>
